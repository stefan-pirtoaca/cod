...
ALTER TABLE Users ADD CONSTRAINT CustomerIsKindOf FOREIGN KEY (userID) REFERENCES Customers (customerID);
ALTER TABLE Users ADD CONSTRAINT EmployeeIsKindOf FOREIGN KEY (userID) REFERENCES Employees (employeeID);
